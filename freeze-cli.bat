py -3.5 "C:\Python35\Scripts\cxfreeze" arky-cli.py --compress --target-dir=../app/arky-cli-amd64 --exclude-modules=matplotlib --icon=ark.ico
...
py -3.5-32 "C:\Program Files (x86)\Python35\Scripts\cxfreeze" arky-cli.py --compress --target-dir=../app/arky-cli-win32 --exclude-modules=matplotlib --icon=ark.ico
